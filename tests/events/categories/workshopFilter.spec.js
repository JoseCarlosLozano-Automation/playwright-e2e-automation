...
test('Workshop category search - Results', async ({ page }) => {
    ...
    // Create an event with Workshop category
    ...
    // Verify that all the events listed are of the Workshop category only
