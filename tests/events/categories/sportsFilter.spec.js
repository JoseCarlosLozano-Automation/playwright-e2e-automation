...
test('Sports category search - Results', async ({ page }) => {
    ...
    // Create an event with Sports category
    ...
    // Verify that all the events listed are of the Sports category only
