...
test('Conference category search - Results', async ({ page }) => {
    ...
    const user = UserData();
    const categorySelected = 'Conference';
    ...
    // Create an event with Conference category
    ...
    // Verify that all the events listed are of the Conference category only
