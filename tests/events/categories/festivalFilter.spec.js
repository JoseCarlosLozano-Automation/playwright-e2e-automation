...
test('Festival category search - Results', async ({ page }) => {
    ...
    const user = UserData();
    const categorySelected = 'Festival';
    ...
    // Create an event with Festival category
    ...
    // Verify that all the events listed are of the Festival category only
